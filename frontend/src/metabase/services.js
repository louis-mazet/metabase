...
export const MetabaseApi = {
  ...
  db_get_custom_schemas: GET("/api/database/:dbId/custom_schemas"),
  db_get_custom_tables: GET("/api/database/:dbId/custom_tables?schema=:schema"),
  db_get_custom_fields: POST("/api/database/:dbId/custom_fields"),
